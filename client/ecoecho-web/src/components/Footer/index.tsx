    ...
    return (
        <footer className=" w-full py-2">
            <div className="flex max-lg:flex-col  gap-3">
                ...
                <ul className="flex flex-wrap mx-auto justify-center gap-x-5 gap-4">
                   
                    <li>
                        <a href="https://www.github.com/anthonytchung/">
                    ...
                    <li>
                        <a href="mailto:anthonytnchung@gmail.com" className="text-xl hover:text-gray-400">
                            <Mail className="inline w-7 h-7" />
                        </a>
                    </li>

                    <li>
                        <a href="https://www.linkedin.com/in/anthonytnchung/" className="text-xl hover:text-gray-400">
